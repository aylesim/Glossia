    ...
    <section className="space-y-4 border border-[var(--border)] bg-[var(--surface)] p-5 sm:p-6">
      <div className="border-b border-[var(--border)] pb-4">
        ...
        <p className="mt-1 text-sm leading-relaxed text-[var(--fg-muted)]">
          All generation calls go to OpenAI. Paste your key here. It is saved only in your browser and never sent to
          any server other than OpenAI. The codebase is open source if you want to verify.{" "}
          <a
